...
Generated: 2026-08-14T03:50:34.452Z
...
- Candidate: `cbe85e117b1db59cdbe8175c59793c3cf2a4a7b8`
...
| M | `codex-rs/core/src/plugins/render.rs` |
| M | `codex-rs/core/src/plugins/render_tests.rs` |
...
- Candidate: `722e717e995b38123b442150ec2c5b149c081e85`
- Impact areas: `dependencies`, `documentation`, `implementation`, `tests`
- Changed paths: 27
...
- Candidate: `53a7f2fd1bd439f16be3269b4945460628d2a39b`
...
| M | `.gitignore` |
| M | `docs/design/2026-08-06-active-work-health.md` |
| A | `docs/design/2026-08-13-active-work-background-shell.md` |
...
| M | `docs/developers/qwen-serve-protocol.md` |
...
| M | `packages/cli/src/acp-integration/acpAgent.test.ts` |
| M | `packages/cli/src/acp-integration/acpAgent.ts` |
| M | `packages/cli/src/acp-integration/active-work-reporter.test.ts` |
| M | `packages/cli/src/acp-integration/active-work-reporter.ts` |
| M | `packages/cli/src/acp-integration/session/Session.review-lease.test.ts` |
| M | `packages/cli/src/acp-integration/session/Session.test.ts` |
| M | `packages/cli/src/acp-integration/session/Session.ts` |
| M | `packages/cli/src/acp-integration/session/Session.worktree.test.ts` |
...
| M | `packages/core/src/services/backgroundShellRegistry.test.ts` |
| M | `packages/core/src/services/backgroundShellRegistry.ts` |
