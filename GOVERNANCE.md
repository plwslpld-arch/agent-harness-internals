...
The repository is maintainer-led. Changes are accepted on evidence quality,
...
If maintainers disagree, the repository records the disputed evidence and
chooses the least misleading reversible presentation. Governance changes are
documented in pull requests and `CHANGELOG.md`.
